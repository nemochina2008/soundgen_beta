...
#'   rolloff = -5, play = TRUE)  # we hope to reproduce this sound
#'
...
#' cand1 = do.call(soundgen, c(m1$pars, list(play = TRUE, temperature = 0)))
#'
...
#' cand2 = do.call(soundgen, c(m2$pars, list(play = TRUE, temperature = 0)))
#' }
