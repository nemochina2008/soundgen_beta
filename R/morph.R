...
#'   ampl=c(240,305,250,260,250)), pitchAnchors_global=data.frame(time=c(0,1),
#'   ampl=c(0,0)), breathingAnchors=data.frame(time=c(-50,1214),
#'   ampl=c(-50,-70)), mouthAnchors=data.frame(time=c(0,0.1,.4,1),
#'   ampl=c(0.18,0.5,.2,.1)), amplAnchors=data.frame(time=c(0,0.16,1),
#'   ampl=c(19,120,120)), amplAnchors_global=data.frame(time=c(0,1),
#'   ampl=c(120,120)), exactFormants=list(f1=data.frame(time=c(0), freq=c(700),
...
#'   windowLength_points=512, overlap=75, pitch_floor=25, pitch_ceiling=3500,
#'   pitchSamplingRate=3500, vocalTract_length=15.5, repeatBout=1,
#'   pitchAnchors=data.frame(time=c(0,0.17,1), ampl=c(383,421,358)),
#'   pitchAnchors_global=data.frame(time=c(0,1), ampl=c(0,0)),
#'   breathingAnchors=data.frame(time=c(0,49,256), ampl=c(-120,10,-120)),
#'   mouthAnchors=data.frame(time=c(0,0.15,1), ampl=c(0,0.49,0.2)),
#'   amplAnchors=data.frame(time=c(0,0.26,1), ampl=c(43,120,43)),
#'   amplAnchors_global=data.frame(time=c(0,1), ampl=c(120,120)),
