...
```{r}
s = soundgen(nSyl = 5, sylLen = 200, pauseLen = 140,
...
for (i in mf){
  par(mfrow = c(1, 3))
  s = soundgen(maleFemale = i, exactFormants = NA, vocalTract = 25, plot = TRUE)
...
s = getSpectralEnvelope(nr = 1024,  # freq bins in FFT frame (window_length / 2)
                        ...
                        colorTheme = 'seewave',
                        rolloff_lipRad = 6) # NB: by default higher frequencies 
