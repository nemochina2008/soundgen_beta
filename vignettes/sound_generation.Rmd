...
Note that lip radiation is specified in exactFormants together with formants!  This has the effect of amplifying higher frequencies to mimic lip radiation. To synthesize a sound using this spectral filter, type:
```{r}
