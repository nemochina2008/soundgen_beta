...
Buckle up now, for the remaining sections are going to be a bit heavier. If the terminology is obscure, don't despair: with a bit of trial-and-error and a quick ear you can quickly master all the following features of soundgen, even if you are not familiar with the theoretical concepts.
...
s = soundgen(exactFormants = exactFormants, play = TRUE)
```
...
s = soundgen(rolloff = -20, rolloffAdjust_per_octave = -3, play = TRUE,
...
```{r fig.width = 5, fig.height = 5}
s = soundgen(subFreq = 75, subDep = 130, pitchEffects_amount = 100,
             jitterDep = 0, shimmerDep = 0, temperature = 0, 
...
s = soundgen(repeatBout = 2, sylLen = 140, pauseLen = 100, vocalTract = 8,
             ...
             pitchEffects_amount = 100, jitterDep = 1, subDep = 60, play = TRUE,
...
s1 = soundgen(vocalTract = 17.5,  # ~human throat
              sylLen = 10, exactFormants = NULL, attackLen = 200, play = TRUE,
