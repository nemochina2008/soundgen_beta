...
To demonstrate acoustic analysis in practice, let's begin by generating a sound with known pitch. To make pitch tracking less trivial and demonstrate some of its challenges, let's add some noise, subharmonics, and jitter:
```{r}
library(soundgen)
