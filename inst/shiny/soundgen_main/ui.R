                        ...
                        navbarMenu ("Main",
                                    ...
                                    tabPanel("Amplitude syllable",
                                             sidebarLayout(
                                               ...
                                               mainPanel(
                                                 plotOutput('plotAmpl_syl', click = "plotAmpl_syl_click", dblclick = dblclickOpts(id = "plotAmpl_syl_dblclick")), width=6
                                               )
                                             )
                                    ),
                                    ...
                                    tabPanel("Variation",
                                             sidebarLayout(
                                               sidebarPanel(
                                                 ...
                                                 sliderInput('formantDepStoch', 'Random formants, dB', value=permittedValues['formantDepStoch','default'], min=permittedValues['formantDepStoch', 'low'], max=permittedValues['formantDepStoch', 'high'], step=permittedValues['formantDepStoch','step']),
                                                 shinyBS:::bsPopover(id='formantDepStoch', title=NULL, content='Amplitude of extra formants on top of user-specified ones', placement="right", trigger="hover"), width=6
                                               ),
                                               mainPanel(
                        ...
                        navbarMenu ("Voiced",
                                    ...
                                    tabPanel("Vowel",
                                             sidebarLayout(
                                               ...
                                               mainPanel(
                                                 plotOutput('plot_formants'), width=6
                                               )
                                             )
                                    ),
                                    ...
                                    tabPanel("Pitch effects",
                                             sidebarLayout(
                                               sidebarPanel(
                                                 sliderInput('pitchEffectsAmount', 'Amount of pitch effects, %', value=permittedValues['pitchEffectsAmount','default'], min=permittedValues['pitchEffectsAmount', 'low'], max=permittedValues['pitchEffectsAmount', 'high'], step=permittedValues['pitchEffectsAmount','step']),
                                                 shinyBS:::bsPopover(id='pitchEffectsAmount', title=NULL, content='Regulates the proportion of sound with pitch effects added stepwise as first vocal fry, then vocal fry + jitter & shimmer.', placement="right", trigger="hover"),
                                                 sliderInput('pitchEffectsIntensity', 'Intensity of pitch effects, % *hyper*', value=permittedValues['pitchEffectsIntensity','default'], min=permittedValues['pitchEffectsIntensity', 'low'], max=permittedValues['pitchEffectsIntensity', 'high'], step=permittedValues['pitchEffectsIntensity','step']),
                                                 shinyBS:::bsPopover(id='pitchEffectsIntensity', title=NULL, content='Regulates the intensity of vocal fry, jitter and shimmer, when these effects are added', placement="right", trigger="hover"),
